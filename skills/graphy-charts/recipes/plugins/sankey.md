...
- Requires `d3-sankey` (`@types/d3-sankey` for TypeScript); swap it for any layout that emits unit-space scalars — never store d3's circular node/link objects in the compiled dataset.
